...
subtitle: "Модель гармонических колебаний - вариант 60"
...
силы $\ddot{x}+2.5\dot{x}+13x=0$
3. Колебания гармонического осциллятора c затуханием и под действием внешней
силы $\ddot{x}+7\dot{x}+6.6x=0.3\sin{12t}$

На итнтервале $t \in [ 0;73 ]$, шаг 0.05, $x_0=1.5, y_0=0$
