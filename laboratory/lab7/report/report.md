...
subtitle: "Модель распространения рекламы - вариант 60"
...
1.	$\frac{dn}{dt} = (0.93 + 0.00005n(t))(N-n(t))$
2.	$\frac{dn}{dt} = (0.00003 + 0.7n(t))(N-n(t))$
3.	$\frac{dn}{dt} = (0.7t + 0.8\sin (t)n(t))(N-n(t))$

При этом объем аудитории $N = 584$, в начальный момент о товаре знает 3 человека.
