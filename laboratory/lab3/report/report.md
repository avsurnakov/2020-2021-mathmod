...
subtitle: "Модель боевых действий - вариант 60"
...
Мы рассмотрим конкретно два случая ведения боевых действий:
1. Боевые действия между регулярными войсками
2. Боевые действия с участием регулярных войск и партизанских
отрядов
...
В начальный момент времени страна $X$ имеет армию численностью 57570 человек, а в распоряжении страны $Y$ армия численностью в 91210 человек.
...
В результате проделанной лабораторной работы я познакомился с моделью «Войны и сражения». 
Проверил, как работает модель в различных ситуациях, построил графики $y(t)$ и $x(t)$ в рассматриваемых случаях.